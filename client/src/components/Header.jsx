  ...
  return (
    <Navbar className="border-b-2">
      <Link
        to="/"
        aria-hidden="true"
        className="flex items-center from-red-600 to-blue-800 bg-gradient-to-r bg-clip-text text-transparent text-2xl font-medium text-indigo-900 dark:text-white "
      >
